...
5. World Wide Web Consortium, *PROV-O: The PROV Ontology*, W3C Recommendation,
   30 April 2013. https://www.w3.org/TR/prov-o/
6. World Wide Web Consortium, *PROV Model Primer*, W3C Working Group Note,
   30 April 2013. https://www.w3.org/TR/prov-primer/
7. World Wide Web Consortium, *PROV-DM: The PROV Data Model*, W3C Recommendation,
   30 April 2013. https://www.w3.org/TR/prov-dm/

## Content provenance

8. Coalition for Content Provenance and Authenticity, *C2PA Technical
   Specification*, version 2.x. https://c2pa.org/specifications/

## Canonicalisation and timestamping

9. A. Rundgren, B. Jordan, and S. Erdtman, *JSON Canonicalization Scheme (JCS)*,
   RFC 8785, Internet Engineering Task Force, June 2020.
   https://www.rfc-editor.org/rfc/rfc8785
10. C. Adams, P. Cain, D. Pinkas, and R. Zuccherato, *Internet X.509 Public Key
...
11. LangChain, *LangGraph — Building stateful, multi-actor applications with
